''' 
Questão 2
Escreva uma função que receba dois números inteiros e que imprima na tela os números
primos existentes entre esses dois números, a função deve imprimir a frase “Não existe
números primos nesse intervalo” caso isso seja verdade.
