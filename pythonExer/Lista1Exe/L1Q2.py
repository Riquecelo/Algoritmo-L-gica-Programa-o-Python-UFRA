...
print(f'O volume do cone é {volume_cone:.2f}')
print(f'O raio do cone é {r_cone:.2f}')
...
print(f'O volume do cilindro é {volume_cilin:.2f}')
...
print(f'O volume do cilindro é {volume_esf:.2f}')
